=== 0.10.0.beta / 2013-04-15

* Experimental support for Sinatra 1.4's Sinatra::Request::AcceptEntry object; note that there is still an issue with the tests regarding resolving the 'application/xml' MIME type (.xsl vs. .xml)

=== 0.9.0 / 2013-02-03

* Add HTTP_ACCEPT header usage
